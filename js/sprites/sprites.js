...
function initSprites() {
  ...
  Sprites.icons = {
    sword: loadIcon('assets/game/items/sword.png'),
    ...
    potionRed: loadIcon('assets/game/items/potion.png'),
    potionBlue: loadIcon('assets/game/items/potion.png'),
    coin: loadIcon('assets/game/items/gold.png'),
    gem: loadIcon('assets/game/items/gem.png'),
    key: buildKeyIcon(),
    shield: buildShieldIcon(),
    shieldBone: buildBoneShieldIcon(),
    crownSkeleton: loadIcon('assets/game/items/crown.png'),
    armorObsidian: buildObsidianArmorIcon(),
    swordMolten: buildMoltenSwordIcon(),
    bootsFireproof: buildFireproofBootsIcon(),
    swordEpic: buildLegendarySwordIcon(),
    swordCursed: buildSwordIcon(),
    armorEpic: buildObsidianArmorIcon(),
    armorCursed: buildArmorIcon(),
    helmetEpic: buildHelmetIcon(),
    shieldCursed: buildShieldIcon(),
    bootsEpic: buildFireproofBootsIcon(),
    bootsCursed: buildBootsIcon(),
    chestCommon: buildChestIcon(RARITY_TIERS.common.color),
    chestUncommon: buildChestIcon(RARITY_TIERS.uncommon.color),
    chestRare: buildChestIcon(RARITY_TIERS.rare.color),
    chestEpic: buildChestIcon(RARITY_TIERS.epic.color),
    chestLegendary: buildChestIcon(RARITY_TIERS.legendary.color),
    chestCursed: buildChestIcon(RARITY_TIERS.cursed.color),
  };
}
