...
const NPC_DEFS = [
  ...
  },
  {
    ...
    spriteKey: 'merchant',
    dialogue: [
      "Ah, una faccia nuova! Non sei armato per la Valle.",
      "Ho armi, armature, pozioni e qualche giocattolo utile.",
      "Prendi questa Pozione di Cura, offerta da me.",
      "Poi guarda il mio banco. Buon viaggio là fuori.",
    ],
    opts: { dir: 'down' },
  },
  {
    ...
    spriteKey: 'merchant',
    dialogue: [
      "Casse magiche da tutti i regni della Valle.",
      "Portami gemme e svelerò un tesoro a caso.",
      "Chi sa? Potrebbe essere leggendario.",
    ],
    opts: { dir: 'down' },
  },
  {
    ...
    spriteKey: 'player',
    dialogue: [
      "La gloria si conquista contro i propri pari, non contro gli slimer.",
      "Combatti in PvP e accumula onore.",
      "Qui troverai ricompense degne di un campione.",
    ],
    opts: { dir: 'down' },
  },
  {
